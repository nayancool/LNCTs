...
public class student_attendence_sheet extends AppCompatActivity {
 ...
 TextView t;
  ...
  ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_attendence_sheet);
    ...
    public void list(ArrayList studentlist,int P,int count,int A){
        ...
        try{
            ...
            t.setText("Your attendence is :"+avg+"%");
            if(average>=75)
