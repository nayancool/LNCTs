...
Toolbar mToolbar;
    ...
    public void addTeacher(View v){
        ...
        if(!(TextUtils.isEmpty(Tid.getText().toString()))){
            ...
            Toast.makeText(getApplicationContext(),"Teacher Added succesfully..",Toast.LENGTH_LONG).show();
            finish();
        }
        else{
    ...
    public void removeTeacher(View v){
        if(!(TextUtils.isEmpty(Tid.getText().toString()))){
            ...
            Toast.makeText(getApplicationContext(),"Teacher removed succesfully",Toast.LENGTH_LONG).show();
            finish();
        }
        else{
